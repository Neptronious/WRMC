...
export const Tooltip: React.FunctionComponent<TooltipProps> = (props) => {
  ...
  const triggerProps: Record<string, unknown> = {
    ...
    onMouseEnter: (e: React.MouseEvent) => {
      (triggerChild.props as Record<string, unknown>).onMouseEnter?.(e);
      show();
    },
    onMouseLeave: (e: React.MouseEvent) => {
      (triggerChild.props as Record<string, unknown>).onMouseLeave?.(e);
      hide();
    },
    onFocus: (e: React.FocusEvent) => {
      (triggerChild.props as Record<string, unknown>).onFocus?.(e);
      show();
    },
    onBlur: (e: React.FocusEvent) => {
      (triggerChild.props as Record<string, unknown>).onBlur?.(e);
      hide();
    },
  };
